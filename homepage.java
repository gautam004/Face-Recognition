...
*/
			...
			con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c1=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c2=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c3=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c4=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c5=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c6=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			c7=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
			//c8=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","dil1","dil1");
